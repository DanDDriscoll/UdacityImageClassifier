...
def create_model(arch, hidden_units, output_size):
    ...
    if arch == 'densenet121':
        ...
        print('The model architecture chose: {}, is not supported. Please choose densenet121 or vgg19'.format(arch))
        return 0
...
def save_model(model, train_data, learning_rate, batch_size, epochs, criterion, optimizer, arch, hidden_units):
    print('Saving model..')
