...
parser.add_argument('--dir', type=str, default='./flowers', help='Path to images to train with')
...
parser.add_argument('--epochs', type=int, default=15, help='Number of training epochs to use')
parser.add_argument('--use_gpu', default=False, action='store_true', help="If you would like to use the GPU for "
                                                                          "training")
parser.add_argument('--output_size', type=int, default=52, help='Number of possible classes/categories for output')
